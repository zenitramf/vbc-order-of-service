/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/announcement-image-gen/wrangler.jsonc workers/announcement-image-gen/worker-configuration.d.ts` (hash: 98e032f5f5d279c433c490e10ba1410b)
// Runtime types generated with workerd@1.20260925.1 2026-06-21 nodejs_compat
interface __BaseEnv_Env {
	SERVICE_PDFS: R2Bucket;
	AI: Ai;
	AI_GATEWAY_ID: "default";
	RICK_REASONING_EFFORT: "medium";
	RICK_AGENT_TOKEN_SECRET: string;
	RICK_MODEL: string;
	RICK_AGENT: DurableObjectNamespace<import("./src/index").RickAgent>;
	PORTAL: Fetcher /* vbc-order-of-service */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RickAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_ID" | "RICK_REASONING_EFFORT" | "RICK_AGENT_TOKEN_SECRET" | "RICK_MODEL">> {}
}
