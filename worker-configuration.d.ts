/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4557d7cd501c926d340a708c39ba32db)
// Runtime types generated with workerd@1.20260616.1 2026-06-21 nodejs_compat
interface __BaseEnv_Env {
	SERVICE_PDFS: R2Bucket;
	DB: D1Database;
	OOS_EMAIL_SENDER: Queue;
	CRAFT_PDF_ID: string;
	CRAFTMYPDF_API_KEY: string;
	PROTON_SMTP_TOKEN: string;
	PROTON_SMTP_SERVER: string;
	PROTON_SMTP_PORT: string;
	PROTON_SMTP_USERNAME: string;
	EMAIL_SETTINGS_ENCRYPTION_KEY: string;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "OrderEmailStatusDurableObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CRAFT_PDF_ID" | "CRAFTMYPDF_API_KEY" | "PROTON_SMTP_TOKEN" | "PROTON_SMTP_SERVER" | "PROTON_SMTP_PORT" | "PROTON_SMTP_USERNAME" | "EMAIL_SETTINGS_ENCRYPTION_KEY" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL">> {}
}
